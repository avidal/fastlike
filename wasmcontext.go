...
func (i *Instance) link(store *wasmtime.Store, linker *wasmtime.Linker) {
	...
	// xqd_http_cache.go
	_ = linker.FuncWrap("fastly_http_cache", "is_request_cacheable", safeWrap1(i, "is_request_cacheable", func(req_handle int32) int32 {
	...
	_ = linker.FuncWrap("fastly_http_cache", "lookup", safeWrap4u2(i, "lookup", func(req_handle int32, options_mask uint32, options int32, cache_handle_out int32) int32 {
		return i.xqd_http_cache_lookup(req_handle, options_mask, options, cache_handle_out)
	}))
	_ = linker.FuncWrap("fastly_http_cache", "transaction_lookup", safeWrap4u2(i, "transaction_lookup", func(req_handle int32, options_mask uint32, options int32, cache_handle_out int32) int32 {
		return i.xqd_http_cache_transaction_lookup(req_handle, options_mask, options, cache_handle_out)
	}))
	_ = linker.FuncWrap("fastly_http_cache", "transaction_insert", safeWrap5u1(i, "transaction_insert", func(cache_handle int32, resp_handle int32, options_mask uint32, options int32, body_handle_out int32) int32 {
		return i.xqd_http_cache_transaction_insert(cache_handle, resp_handle, options_mask, options, body_handle_out)
	}))
	_ = linker.FuncWrap("fastly_http_cache", "transaction_insert_and_stream_back", safeWrap6u1(i, "transaction_insert_and_stream_back", func(cache_handle int32, resp_handle int32, options_mask uint32, options int32, body_handle_out int32, cache_handle_out int32) int32 {
	...
	_ = linker.FuncWrap("fastly_http_cache", "transaction_update", safeWrap4u1(i, "transaction_update", func(cache_handle int32, resp_handle int32, options_mask uint32, options int32) int32 {
		return i.xqd_http_cache_transaction_update(cache_handle, resp_handle, options_mask, options)
	}))
	_ = linker.FuncWrap("fastly_http_cache", "transaction_update_and_return_fresh", safeWrap5u1(i, "transaction_update_and_return_fresh", func(cache_handle int32, resp_handle int32, options_mask uint32, options int32, cache_handle_out int32) int32 {
	...
	_ = linker.FuncWrap("fastly_http_cache", "transaction_record_not_cacheable", safeWrap3u1(i, "transaction_record_not_cacheable", func(cache_handle int32, options_mask uint32, options int32) int32 {
	...
	_ = linker.FuncWrap("fastly_http_cache", "get_suggested_cache_options", safeWrap6u1(i, "get_suggested_cache_options", func(cache_handle int32, resp_handle int32, requested_mask uint32, requested_options int32, options_mask_out int32, options_out int32) int32 {
	...
	_ = linker.FuncWrap("fastly_http_cache", "get_found_response", safeWrap4u2(i, "get_found_response", func(cache_handle int32, transform_for_client uint32, resp_handle_out int32, body_handle_out int32) int32 {
	...
	// xqd_erl.go
	_ = linker.FuncWrap("fastly_erl", "check_rate", safeWrap11u(i, "check_rate", func(rc_addr int32, rc_size int32, entry_addr int32, entry_size int32, delta uint32, window uint32, limit uint32, pb_addr int32, pb_size int32, ttl uint32, blocked_out int32) int32 {
		return i.xqd_erl_check_rate(rc_addr, rc_size, entry_addr, entry_size, delta, window, limit, pb_addr, pb_size, ttl, blocked_out)
	}))
	_ = linker.FuncWrap("fastly_erl", "ratecounter_increment", safeWrap5u2(i, "ratecounter_increment", func(rc_addr int32, rc_size int32, entry_addr int32, entry_size int32, delta uint32) int32 {
		return i.xqd_erl_ratecounter_increment(rc_addr, rc_size, entry_addr, entry_size, delta)
	}))
	_ = linker.FuncWrap("fastly_erl", "ratecounter_lookup_rate", safeWrap6u2(i, "ratecounter_lookup_rate", func(rc_addr int32, rc_size int32, entry_addr int32, entry_size int32, window uint32, rate_out int32) int32 {
		return i.xqd_erl_ratecounter_lookup_rate(rc_addr, rc_size, entry_addr, entry_size, window, rate_out)
	}))
	_ = linker.FuncWrap("fastly_erl", "ratecounter_lookup_count", safeWrap6u2(i, "ratecounter_lookup_count", func(rc_addr int32, rc_size int32, entry_addr int32, entry_size int32, duration uint32, count_out int32) int32 {
		return i.xqd_erl_ratecounter_lookup_count(rc_addr, rc_size, entry_addr, entry_size, duration, count_out)
	}))
	_ = linker.FuncWrap("fastly_erl", "penaltybox_add", safeWrap5u2(i, "penaltybox_add", func(pb_addr int32, pb_size int32, entry_addr int32, entry_size int32, ttl uint32) int32 {
	...
	_ = linker.FuncWrap("fastly_kv_store", "insert", safeWrap10u1(i, "insert", func(store_handle int32, key_addr int32, key_size int32, body_handle int32, metadata_addr int32, metadata_size int32, insert_mode int32, insert_config_mask uint32, insert_config_buf int32, insert_handle_out int32) int32 {
	...
	_ = linker.FuncWrap("fastly_kv_store", "list", safeWrap4u2(i, "list", func(store_handle int32, list_config_mask uint32, list_config_buf int32, list_handle_out int32) int32 {
	...
	// xqd_cache.go
	_ = linker.FuncWrap("fastly_cache", "lookup", safeWrap5u1(i, "lookup", func(cache_key int32, cache_key_len int32, options_mask uint32, options int32, handle_out int32) int32 {
		return i.xqd_cache_lookup(cache_key, cache_key_len, options_mask, options, handle_out)
	}))
	_ = linker.FuncWrap("fastly_cache", "insert", safeWrap5u1(i, "insert", func(cache_key int32, cache_key_len int32, options_mask uint32, options int32, body_handle_out int32) int32 {
		return i.xqd_cache_insert(cache_key, cache_key_len, options_mask, options, body_handle_out)
	}))
	_ = linker.FuncWrap("fastly_cache", "transaction_lookup", safeWrap5u1(i, "transaction_lookup", func(cache_key int32, cache_key_len int32, options_mask uint32, options int32, cache_handle_out int32) int32 {
		return i.xqd_cache_transaction_lookup(cache_key, cache_key_len, options_mask, options, cache_handle_out)
	}))
	_ = linker.FuncWrap("fastly_cache", "transaction_lookup_async", safeWrap5u1(i, "transaction_lookup_async", func(cache_key int32, cache_key_len int32, options_mask uint32, options int32, cache_busy_handle_out int32) int32 {
	...
	_ = linker.FuncWrap("fastly_cache", "transaction_insert", safeWrap4u2(i, "transaction_insert", func(cache_handle int32, options_mask uint32, options int32, body_handle_out int32) int32 {
		return i.xqd_cache_transaction_insert(cache_handle, options_mask, options, body_handle_out)
	}))
	_ = linker.FuncWrap("fastly_cache", "transaction_insert_and_stream_back", safeWrap5u3(i, "transaction_insert_and_stream_back", func(cache_handle int32, options_mask uint32, options int32, body_handle_out int32, cache_handle_out int32) int32 {
		return i.xqd_cache_transaction_insert_and_stream_back(cache_handle, options_mask, options, body_handle_out, cache_handle_out)
	}))
	_ = linker.FuncWrap("fastly_cache", "transaction_update", safeWrap3u1(i, "transaction_update", func(cache_handle int32, options_mask uint32, options int32) int32 {
	...
	_ = linker.FuncWrap("fastly_cache", "get_body", safeWrap4u2(i, "get_body", func(cache_handle int32, options_mask uint32, options int32, body_handle_out int32) int32 {
	...
	_ = linker.FuncWrap("fastly_cache", "replace", safeWrap5u1(i, "replace", func(cache_key int32, cache_key_len int32, options_mask uint32, options int32, replace_handle_out int32) int32 {
		return i.xqd_cache_replace(cache_key, cache_key_len, options_mask, options, replace_handle_out)
	}))
	_ = linker.FuncWrap("fastly_cache", "replace_insert", safeWrap4u2(i, "replace_insert", func(replace_handle int32, options_mask uint32, options int32, body_handle_out int32) int32 {
	...
	_ = linker.FuncWrap("fastly_cache", "replace_get_body", safeWrap4u2(i, "replace_get_body", func(replace_handle int32, options_mask uint32, options int32, body_handle_out int32) int32 {
	...
	// xqd_purge.go
	_ = linker.FuncWrap("fastly_purge", "purge_surrogate_key", safeWrap4u1(i, "purge_surrogate_key", func(surrogate_key int32, surrogate_key_len int32, options_mask uint32, options int32) int32 {
	...
	_ = linker.FuncWrap("fastly_http_downstream", "downstream_client_ddos_detected", safeWrap1(i, "downstream_client_ddos_detected", func(req_handle int32) int32 {
		return i.xqd_http_downstream_client_ddos_detected(req_handle)
	}))
	...
	_ = linker.FuncWrap("fastly_http_downstream", "fastly_key_is_valid", safeWrap1(i, "fastly_key_is_valid", func(req_handle int32) int32 {
		return i.xqd_http_downstream_fastly_key_is_valid(req_handle)
	}))
}
...
func (i *Instance) linklegacy(store *wasmtime.Store, linker *wasmtime.Linker) {
	...
	// xqd_image_optimizer.go
	_ = linker.FuncWrap("env", "xqd_image_optimizer_transform_request", safeWrap9u1(i, "xqd_image_optimizer_transform_request", func(a, b, c, d int32, e uint32, f, g, h, j int32) int32 { return i.xqd_image_optimizer_transform_request(a, b, c, d, e, f, g, h, j) }))
	...
	// xqd_erl.go
	_ = linker.FuncWrap("env", "xqd_erl_check_rate", safeWrap11u(i, "xqd_erl_check_rate", func(rc_addr, rc_size, entry_addr, entry_size int32, delta, window, limit uint32, pb_addr, pb_size int32, ttl uint32, blocked_out int32) int32 { return i.xqd_erl_check_rate(rc_addr, rc_size, entry_addr, entry_size, delta, window, limit, pb_addr, pb_size, ttl, blocked_out) }))
	_ = linker.FuncWrap("env", "xqd_erl_ratecounter_increment", safeWrap5u2(i, "xqd_erl_ratecounter_increment", func(a int32, b int32, c int32, d int32, e uint32) int32 { return i.xqd_erl_ratecounter_increment(a, b, c, d, e) }))
	_ = linker.FuncWrap("env", "xqd_erl_ratecounter_lookup_rate", safeWrap6u2(i, "xqd_erl_ratecounter_lookup_rate", func(a int32, b int32, c int32, d int32, e uint32, f int32) int32 { return i.xqd_erl_ratecounter_lookup_rate(a, b, c, d, e, f) }))
	_ = linker.FuncWrap("env", "xqd_erl_ratecounter_lookup_count", safeWrap6u2(i, "xqd_erl_ratecounter_lookup_count", func(a int32, b int32, c int32, d int32, e uint32, f int32) int32 { return i.xqd_erl_ratecounter_lookup_count(a, b, c, d, e, f) }))
	_ = linker.FuncWrap("env", "xqd_erl_penaltybox_add", safeWrap5u2(i, "xqd_erl_penaltybox_add", func(a int32, b int32, c int32, d int32, e uint32) int32 { return i.xqd_erl_penaltybox_add(a, b, c, d, e) }))
